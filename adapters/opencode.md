...
```sh
printf '\nFor learning requests, read /absolute/path/to/active-recall-learning-system/protocol/learning-policy.md and the applicable skills/*.md in that repository. Enforce source citations, confirmation, and incremental persistence.\n' >> AGENTS.md
