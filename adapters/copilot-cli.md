...
For active-recall learning requests, read /absolute/path/to/active-recall-learning-system/protocol/learning-policy.md and the matching skills/*.md. Citations, explicit confirmation, and incremental session saves are mandatory.
EOF
