...
9. Generate a local, queryable snapshot dashboard: `learning dashboard ~/Learning` and open `~/Learning/dashboard.html` directly in a browser. It is read-only derived output; regenerate it after studying.
